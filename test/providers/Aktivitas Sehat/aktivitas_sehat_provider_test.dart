...
void main() {
  ...
  group('load()', () {
    ...
    testWidgets('loading menjadi true lalu false saat load()',
        (tester) async {
      final aktivitasList = [
        AktivitasModel(
          id: '1', uid: 'user-123',
    ...
    testWidgets('list terisi data dari _get setelah load()',
        (tester) async {
      final data = [
        AktivitasModel(
          id: 'a1', uid: 'user-123',
        ...
        AktivitasModel(
          id: 'a2', uid: 'user-123',
          judul: 'Renang', deskripsi: 'Renang pagi',
          createdAt: DateTime.now(),
        ),
      ];
  ...
  group('add()', () {
    ...
    testWidgets('add() memanggil _create lalu _get',
        (tester) async {
...
group('add() validasi input [MODIFIKASI]', () {
  ...
  testWidgets('add() throw error jika judul kosong',
      (tester) async {
    await tester.pumpWidget(buildTestApp(
      child: Builder(builder: (ctx) {
        return ElevatedButton(
  ...
  testWidgets('add() throw error jika deskripsi kosong',
      (tester) async {
    await tester.pumpWidget(buildTestApp(
      child: Builder(builder: (ctx) {
        return ElevatedButton(
  ...
  testWidgets('add() throw error jika judul hanya spasi',
      (tester) async {
    await tester.pumpWidget(buildTestApp(
      child: Builder(builder: (ctx) {
        return ElevatedButton(
  ...
  group('edit()', () {
    ...
    testWidgets('edit() memanggil _update dengan model yang benar',
      ...
      final model = AktivitasModel(
        id: 'xyz', uid: 'user-123',
        judul: 'Push Up Edit', deskripsi: 'Edit deskripsi',
        createdAt: DateTime.now(),
      );
